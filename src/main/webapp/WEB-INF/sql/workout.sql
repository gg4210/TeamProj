...
CREATE SEQUENCE SEQ_AUTH_SECURITY_SECNO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_BBS_Comment_CNO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_BBS_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_BookMark_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CenterReview_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;

CREATE SEQUENCE SEQ_COUPON_CNO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CustomerService_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_C_KIND_LIST_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_healthMate_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_MESSAGE_TABLE_MNO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;

CREATE SEQUENCE SEQ_MY_MATE_YNO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_RegiCenter_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_SCRAP_NO INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
