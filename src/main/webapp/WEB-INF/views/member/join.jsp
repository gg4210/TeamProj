...
<div class="container pt-20" id="cujoin">
   	<div class="row align-self-center" id="curow">
   		<form class="text-center border border-light pt-5 pl-5 pr-5 pb-4" action="#!">
				...
				<div class="col-3" style="margin-top:5%;">
			   	...
			   	<div class="col-9">
					...
					<div class="form-inline text-left">
						...
						<input maxlength="14" type="text" id="Id" class="form-control mb-1 col-md-4" placeholder="아이디">
				    ...
				    <div class="form-inline text-left">
					    ...
					    <input type="password" maxlength="16" id="Password" class="form-control col-md-5 mb-3" placeholder="비밀번호를 입력하세요.">
				    </div>
				    ...
				    <div class="form-inline mb-2">
				    	<label class="col-md-2">이메일 주소:</label>
			...
			<button class="btn btn-info offset-md-10 col-md-2" id="startchange" type="button">가입 완료</button>
		</form>
	</div>
</div>