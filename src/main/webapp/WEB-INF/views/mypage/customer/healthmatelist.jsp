...
$(function(){
   ...
   var showMessage=function(data){
      ...
      var fromid=$('#SIM > td:nth-child(2)').attr('id');
   ...
   //메세지 보내기]
       $('#send').click(function(){
         ...
         var fromid=$('#SIM > td:nth-child(2)').closest('table').attr('id');
         console.log("send 클릭 시 fromid:"+fromid);
   ...
   $('.healthMate').click(function(){
       var fromid=$('#SIM > td:nth-child(2)').closest('table').attr('id');
      console.log('fromid 메이트 클릭'+fromid);
            ...
            <table class="table table-hover">
               ...
               <c:forEach var="toMate" items="${ToMateList}" varStatus="loop">
                   <tr class="healthMate">
                     ...
                     <td class="align-middle text-center" id="${toMate.FRIEND_ID }">${toMate.FRIEND_ID }</td>
