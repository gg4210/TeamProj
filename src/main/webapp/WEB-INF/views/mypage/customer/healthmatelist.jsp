...
<div class="container">
   ...
   <div class="col-md-6">
         ...
         <div>
            <div class="float-right">
               <button class="btn purple-gradient p-2 px-4" onclick="hwagin()">쪽지삭제</button>
            </div>
            <table class="table table-hover matelist-checkbox">
               <thead class="black white-text">
                  <tr>
                     <th style="width:5%" scope="col">
                        <div class="custom-control custom-checkbox" id="matelist-checkbox-all">
                            <input type="checkbox" class="custom-control-input" id="checkall" value="check-all">
   ...
   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#messageModalScrollable">
      모달 테스트용
   </button>
